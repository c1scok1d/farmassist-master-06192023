...
class NewsCard extends StatelessWidget {
  ...
  final String type;
  const NewsCard({Key? key, required this.artical, this.isVideoNews = false, this.type = ''})
      : super(key: key);
        ...
        child: FittedBox(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: Theme.of(context).bottomAppBarColor),
                child: Icon(
                  Icons.play_arrow,
    ...
    return InkWell(
        onTap: () {
          ...
          Navigator.push(
              context,
              PageTransition(
                  type: PageTransitionType.leftToRightWithFade, child: NewsDetailPage()));
        },
        child: Container(
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text(artical.getDateOnly(), style: AppTheme.subtitle2),
                      ),
                    ],
                  )
                ],
