...
import 'package:farmassist/ui/devices/model/save_user_response.dart';
...
class DevicesRepository {
  ...
  Future<SaveUserResponse> saveUser(String loginToken, String? name, String? email) async {
    final response =
        await http.post(Uri.parse("$base/user/save"), body: {"login_token": loginToken, "name": name, "email": email});
